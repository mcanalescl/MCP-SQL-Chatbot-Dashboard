...
st.set_page_config(
    ...
    menu_items={
        "Report a bug": "https://github.com/mcanalescl/MCP-SQL-Chatbot-Dashboard/issues"
    }
)
...
with st.sidebar:
    ...
    st.markdown("👨‍💻 Developed as an AI experiment. Contribute on [GitHub](https://github.com/mcanalescl/MCP-SQL-Chatbot-Dashboard)")
